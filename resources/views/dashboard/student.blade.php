<div class="mt-8 bg-white rounded">
        <div class="w-full max-w-2xl px-6 py-12">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <span class="text-gray-600 font-bold">{{ $student->university_id }}</span>
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <span class="text-gray-600 font-bold">{{ $student->phone2 }}</span>
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3 block text-gray-600 font-bold">
                    <span class="text-gray-600 font-bold">{{ $student->course->course_name }}</span>
                </div>
            </div>
