...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Attach Subject</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('store.course.assign.subject',$courseid) }}" method="POST" class="w-full max-w-lg px-6 py-12">
                @csrf
        ...
        <div class="w-full py-12">
            ...
            <div class="flex items-center bg-gray-200">
                ...
                <div class="w-1/4 text-right text-gray-600 py-2 px-4 font-semibold">University ID</div>
            </div>
            @foreach ($assigned->students as $student)
                <div class="flex items-center justify-between border border-gray-200 mb-px">
                    ...
                    <div class="w-1/4 text-right text-gray-600 py-2 px-4 font-medium">{{ $student->university_id }}</div>
                </div>
            @endforeach
        </div>
    </div>
